...
|<a id='apr' />[apr](http://apr.apache.org/)|[Apache-2.0](http://www.apache.org/licenses/LICENSE-2.0.html 'Apache License, Version 2.0')|Apache Portable Runtime project [deps: _Threads_]|[xpv1.7.6.6](https://github.com/externpro/apr/releases/tag/xpv1.7.6.6 'release')|[repo](https://github.com/externpro/apr 'github.com/externpro/apr') [upstream](https://github.com/apache/apr 'github.com/apache/apr')|[diff](https://github.com/externpro/apr/compare/1.7.6...xpv1.7.6.6 'github.com/externpro/apr/compare/1.7.6...xpv1.7.6.6') [patch[msw], auto[unix]]|
